...
public class VFEKPSPublicSoap12
{
    interface VFEIWcfMethod
    {
        VFEExtendedSoapSerializationEnvelope CreateSoapEnvelope() throws java.lang.Exception;

        java.lang.Object ProcessResult(VFEExtendedSoapSerializationEnvelope __envelope,java.lang.Object result) throws java.lang.Exception;
    }
    ...
    public VFEKPSPublicSoap12(){}

    public VFEKPSPublicSoap12(String url)
    {
        this.url = url;
    }

    public VFEKPSPublicSoap12(String url,int timeOut)
    {
        this.url = url;
    ...
    protected VFEExtendedSoapSerializationEnvelope createEnvelope()
    {
        VFEExtendedSoapSerializationEnvelope envelope= new VFEExtendedSoapSerializationEnvelope(VFEExtendedSoapSerializationEnvelope.VER12);
    ...
    protected java.util.List sendRequest(String methodName,VFEExtendedSoapSerializationEnvelope envelope,org.ksoap2.transport.Transport transport ,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile )throws java.lang.Exception
    {
    ...
    java.lang.Object getResult(java.lang.Class destObj,java.lang.Object source,String resultName,VFEExtendedSoapSerializationEnvelope __envelope) throws java.lang.Exception
    {
        if(source==null)
        {
            return null;
    ...
    public Boolean TCKimlikNoDogrula(final Long TCKimlikNo,final String Ad,final String Soyad,final Integer DogumYili) throws java.lang.Exception
    {
        ...
        return (Boolean)execute(new VFEIWcfMethod()
        {
            @Override
            public VFEExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                VFEExtendedSoapSerializationEnvelope __envelope = createEnvelope();
            ...
            @Override
            public java.lang.Object ProcessResult(VFEExtendedSoapSerializationEnvelope __envelope,java.lang.Object __result)throws java.lang.Exception {
    ...
    protected java.lang.Object execute(VFEIWcfMethod wcfMethod,String methodName,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile) throws java.lang.Exception
    {
        org.ksoap2.transport.Transport __httpTransport=createTransport();
        __httpTransport.debug=enableLogging;
        VFEExtendedSoapSerializationEnvelope __envelope=wcfMethod.CreateSoapEnvelope();
        try
        {
    ...
    protected java.lang.Exception convertToException(org.ksoap2.SoapFault fault,VFEExtendedSoapSerializationEnvelope envelope)
    {
