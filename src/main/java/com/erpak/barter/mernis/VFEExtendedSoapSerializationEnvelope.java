...
class VFESoapFaultEx extends org.ksoap2.SoapFault
{
    public Object fault;
}
...
public class VFEExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(VFEDateTimeConverter converter)
    {
        if(converter==null)
        {
            converter = new VFEStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static VFEDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static VFEDateTimeConverter dateTimeConverter = new VFEStandardDateTimeConverter();

    public VFEExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public VFEExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new VFEMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=VFEHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,VFEExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=VFEHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
