...
public class VFEKPSPublicSoap
{
    ...
    public VFEKPSPublicSoap(){}

    public VFEKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public VFEKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        VFEExtendedSoapSerializationEnvelope envelope= new VFEExtendedSoapSerializationEnvelope(VFEExtendedSoapSerializationEnvelope.VER11);
